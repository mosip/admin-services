...
public class SimplePutForAutoGenId extends MasterDataUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SimplePutForAutoGenId.class);
	...
	public void sestResultTestName(ITestResult result) {
