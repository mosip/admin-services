...
public class AuthenticationException extends BaseUncheckedException {
	 ...
	 * @param statusCode the status code
	 */
	public AuthenticationException(HotlistErrorConstants exceptionConstant, int statusCode) {
	 ...
	 * @param statusCode the status code
	 */
	public AuthenticationException(HotlistErrorConstants exceptionConstant, Throwable rootCause, int statusCode) {
