 ...
 * @author Manoj SP
 */
@Configuration(value = "hotlist_swagger_config")
@EnableSwagger2
public class SwaggerConfig {
	 ...
	 */
	ApiInfo getApiInfo() {
		return new ApiInfoBuilder().title("Hotlisting Service").description("Hotlisting Service").build();
	}
	...
	public Docket api() throws MalformedURLException {
		...
		Docket docket = new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("io.mosip.hotlist.controller"))
