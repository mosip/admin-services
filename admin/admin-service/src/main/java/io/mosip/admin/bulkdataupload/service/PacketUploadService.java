...
import io.mosip.admin.packetstatusupdater.util.PacketRestClient;
...
public class PacketUploadService {
    ...
    @Autowired
    private PacketRestClient restClient;
    ...
    public PacketUploadStatus syncAndUploadPacket(String fileName, byte[] file, String centerId, String supervisorStatus,
                                    String source, String process, String transactionId) throws JSONException, InterruptedException {
        ...
        ResponseEntity<String> responseEntity = syncRegistration(centerId, source, process, fileName, file, supervisorStatus,
                additionalInfoFields, transactionId);
    ...
    private ResponseEntity<String> syncRegistration(String centerId, String source, String process, String fileName, byte[] file, String supervisorStatus,
                                 List<String> additionalInfoFields,  String transactionId) throws InterruptedException {
        ...
        try {
            ...
            FileUtils.writeByteArrayToFile(packet, onlineCrypto.decrypt(id, file));
            ...
            String encodedData = CryptoUtil.encodeToURLSafeBase64(onlineCrypto.encrypt(id,
