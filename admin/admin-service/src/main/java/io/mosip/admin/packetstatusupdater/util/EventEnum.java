...
public enum EventEnum {
    ...
    ADMIN_NOT_AUTHORIZED("ADM-PKT-001",AuditConstant.AUDIT_USER,"Authorization request","User %s is not authorized","ADM-PKT","Packet service","NO_ID","NO_ID_TYPE",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	RID_INVALID("ADM-PKT-002",AuditConstant.AUDIT_USER,"Check RID validation","Registration id is invalid","ADM-PKT","Packet service","NO_ID","NO_ID_TYPE",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	CENTRE_NOT_EXISTS("ADM-PKT-003",AuditConstant.AUDIT_USER,"Check centre exists","Centre id extracted from registration id does not exists","ADM-PKT","Packet service","NO_ID","NO_ID_TYPE",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	RID_MISS("ADM-PKT-004",AuditConstant.AUDIT_USER,"Check RID exists","Registration id is missing in the input","ADM-PKT","Packet service","NO_ID","NO_ID_TYPE",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	PACKET_STATUS_ERROR("ADM-PKT-005",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","System error has occured while fetching Packet Status for registration id %s","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	...
	PACKET_STATUS("ADM-PKT-104",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","Getting Packet status for %s","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	PACKET_RECEIVER("ADM-PKT-105",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","Packet with registration id %s has reached Packet Receiver","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	PACKET_RECEIVER_WITH_TRANS_CODE("ADM-PKT-106",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","Packet with registration id %s is Uploaded to Landing Zone","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	UPLOAD_PACKET("ADM-PKT-107",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","Packet with registration id %s uploaded to Packet Store","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	PRINT_SERVICE("ADM-PKT-108",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","PDF for registration id %s is added to Queue for Printing","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	PRINT_POSTAL_SERVICE("ADM-PKT-109",AuditConstant.AUDIT_SYSTEM,"Request for get packet status","Printing and Post Completed for for registration id %s","ADM-PKT","Packet service","%s","RID",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
	AUTH_FAILED_AUTH_MANAGER("ADM-PKT-403",AuditConstant.AUDIT_SYSTEM,"Check authentication","Authentication failed from AuthManager","ADM-PKT","Packet service","NO_ID","NO_ID_TYPE",AuditConstant.APPLICATION_ID,AuditConstant.APPLICATION_NAME),
