...
public class MasterdataProxyController {
	...
	public ResponseEntity<?> safeMasterDataProxyController(@RequestParam(name = "body", required = true) String body, HttpServletRequest request) {
	...
	public ResponseEntity<?> unsafeMasterDataProxyController(@RequestBody(required = false) String body,
