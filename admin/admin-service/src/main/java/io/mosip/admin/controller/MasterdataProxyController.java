...
import io.mosip.admin.service.MasterDataProxyService;
...
@Tag(name = "proxy-master data-controller", description = "Proxy Masterdata Controller")
public class MasterdataProxyController {
	...
	@Autowired
	private MasterDataProxyService service;
