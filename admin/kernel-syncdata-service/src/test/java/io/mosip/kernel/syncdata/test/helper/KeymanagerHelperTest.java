...
public class KeymanagerHelperTest {
    ...
    @Test
    public void testGetCertificate_Success_NoErrors_WithReferenceId() throws Exception {
    ...
    @Test
    public void testGetCertificate_Success_EmptyErrors_NoReferenceId() throws Exception {
        KeyPairGenerateResponseDto expected = new KeyPairGenerateResponseDto();
        ResponseWrapper<KeyPairGenerateResponseDto> wrapper = new ResponseWrapper<>();
        wrapper.setResponse(expected);
    ...
    public void testGetCertificate_WithErrors_ThrowsSyncDataServiceException() throws Exception {
        ResponseWrapper<KeyPairGenerateResponseDto> wrapper = new ResponseWrapper<>();
    ...
    @Test(expected = SyncDataServiceException.class)
    public void testGetCertificate_RestTemplateThrows_ThrowsSyncDataServiceException() throws Exception {
    ...
    @Test
    public void testGetSignature_Success_ReturnsJwtSignedData() throws Exception {
    ...
    public void testGetSignature_WithErrors_ThrowsSyncInvalidArgumentException() throws Exception {
        JWTSignatureResponseDto responseDto = new JWTSignatureResponseDto();
        ResponseWrapper<JWTSignatureResponseDto> wrapper = new ResponseWrapper<>();
        wrapper.setResponse(responseDto);
        final ServiceError serviceError = new ServiceError("TEST", "TEST");
    ...
    public void testGetSignature_RestTemplateThrows_PropagatesException() throws Exception {
    ...
    @Test
    public void testGetFileSignature_DelegatesToGetSignature() throws Exception {
