...
public class ClientSettingsHelperTest {
    ...
    @Test
    public void testHasURLDetails_NoProperty_ReturnsFalse() {
    ...
    @Test
    public void testHasURLDetails_OnlyOnFullSyncTrueAndDeltaSyncTrue_ReturnsFalse() {
    ...
    @Test
    public void testHasURLDetails_OnlyOnFullSyncFalseAndDeltaSyncTrue_ReturnsTrue() {
        when(environment.containsProperty("mosip.sync.entity.url.APPAUTHENTICATIONMETHOD")).thenReturn(true);
        when(environment.getProperty(
                eq("mosip.sync.entity.only-on-fullsync.APPAUTHENTICATIONMETHOD"),
                eq(Boolean.class),
    ...
    @Test
    public void testGetLastUpdatedTimeFromEntity_FullSyncEntity_ReturnsNull() {
    ...
    @Test
    public void testGetLastUpdatedTimeFromEntity_NotFullSyncEntity_ReturnsOriginal() {
        LocalDateTime lastUpdated = LocalDateTime.now().minusDays(1);
    ...
    @Test
    public void testGetInitiateDataFetch_FullSyncMachine_PassesNullLastUpdatedForMachine() {
        String machineId = "M1";
    ...
    @Test
    public void testGetInitiateDataFetch_UsesUrlDetailsWhenConfigured() {
        String machineId = "M1";
        String regCenterId = "RC1";
        LocalDateTime lastUpdated = LocalDateTime.now().minusDays(1);
        LocalDateTime current = LocalDateTime.now();
    ...
    @Test
    public void testRetrieveData_StructuredUrl_Success() throws Exception {
    ...
    @Test
    public void testRetrieveData_StructuredUrl_EncryptionError_ReturnsEmpty() throws Exception {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
        Map<String, Object> urlMap = new HashMap<>();
        urlMap.put("url", "http://example.com");
        futures.put(AppAuthenticationMethod.class, CompletableFuture.completedFuture(urlMap));
    ...
    @Test
    public void testRetrieveData_Dynamic_V2_UsesServiceHelperV2() {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
    ...
    @Test
    public void testRetrieveData_Dynamic_NonV2_UsesServiceHelperLegacy() {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
        DynamicFieldDto d1 = new DynamicFieldDto();
        d1.setName("fieldName");
        DynamicFieldDto d2 = new DynamicFieldDto();
    ...
    @Test
    public void testRetrieveData_Structured_V2_UsesSyncDataBaseDtoV2() {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
    ...
    @Test
    public void testRetrieveData_Structured_NonV2_UsesSyncDataBaseDto() {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
        List<String> data = Collections.singletonList("val");
        futures.put(Holiday.class, CompletableFuture.completedFuture(data));
        RegistrationCenterMachineDto regCenterMachineDto = new RegistrationCenterMachineDto();
    ...
    public void testRetrieveData_FutureThrowsRuntimeException_WrappedInRuntimeException() {
        Map<Class<?>, CompletableFuture<?>> futures = new HashMap<>();
    ...
    @Test
    public void testGetConfiguredScriptUrlDetail_Success() throws Exception {
    ...
    @Test
    public void testGetConfiguredScriptUrlDetail_MapperThrows_ExceptionIsSwallowed() throws Exception {
        Set<String> scriptNames = new HashSet<>();
        scriptNames.add("applicanttype.mvel");
        ReflectionTestUtils.setField(helper, "scriptNames", scriptNames);
        when(environment.getProperty(anyString())).thenReturn(null);
