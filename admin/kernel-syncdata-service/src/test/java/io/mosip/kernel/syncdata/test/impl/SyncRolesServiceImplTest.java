...
public class SyncRolesServiceImplTest {
    ...
    public void testGetAllRoles_Http401_WithErrors_ThrowsAuthNException() throws Exception {
    ...
    public void testGetAllRoles_Http401_NoErrors_ThrowsBadCredentialsException() throws Exception {
    ...
    public void testGetAllRoles_Http403_WithErrors_ThrowsAuthZException() throws Exception {
        String errorBody = buildBodyWithErrors();
        HttpClientErrorException ex = HttpClientErrorException.create(
    ...
    public void testGetAllRoles_Http403_NoErrors_ThrowsAccessDeniedException() throws Exception {
        String errorBody = buildSuccessBody();
        HttpClientErrorException ex = HttpClientErrorException.create(
                HttpStatus.FORBIDDEN,
                "403",
    ...
    public void testGetAllRoles_Http500_ThrowsSyncDataServiceException() throws Exception {
        String errorBody = buildSuccessBody();
    ...
    public void testGetAllRoles_ResponseHasValidationErrors_ThrowsSyncServiceException() throws Exception {
    ...
    public void testGetAllRoles_ParseResponseIOException_ThrowsParseResponseException() {
