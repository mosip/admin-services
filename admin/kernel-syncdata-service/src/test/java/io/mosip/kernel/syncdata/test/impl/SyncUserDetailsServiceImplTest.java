...
public class SyncUserDetailsServiceImplTest {
    ...
    public void testGetUserDetailsFromAuthServer_nullIds() {
        service.getUserDetailsFromAuthServer(null);
    }

    @Test(expected = NullPointerException.class)
    public void testGetUserDetailsFromAuthServer_emptyIds() {
        service.getUserDetailsFromAuthServer(Arrays.asList());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testGetUserDetailsFromAuthServer_nullResponse() throws Exception {
    ...
    public void testGetUserDetailsFromAuthServer_emptyResponse() throws Exception {
        List<String> ids = Arrays.asList("u1", "u2");
    ...
    public void testGetUserDetailsFromAuthServer_401_WithErrors_ThrowsAuthN() throws Exception {
    ...
    public void testGetUserDetailsFromAuthServer_401_NoErrors_ThrowsBadCredentials() throws Exception {
        List<String> ids = Collections.singletonList("u1");
        ResponseWrapper<Object> wrapper = new ResponseWrapper<>();
        String body = objectMapper.writeValueAsString(wrapper);
        HttpClientErrorException ex = HttpClientErrorException.create(
    ...
    public void testGetUserDetailsFromAuthServer_403_WithErrors_ThrowsAuthZ() throws Exception {
        List<String> ids = Collections.singletonList("u1");
    ...
    public void testGetUserDetailsFromAuthServer_403_NoErrors_ThrowsAccessDenied() throws Exception {
        List<String> ids = Collections.singletonList("u1");
        ResponseWrapper<Object> wrapper = new ResponseWrapper<>();
        String body = objectMapper.writeValueAsString(wrapper);
        HttpClientErrorException ex = HttpClientErrorException.create(
    ...
    public void testGetUserDetailsFromAuthServer_500_ThrowsSyncDataServiceException() throws Exception {
        List<String> ids = Collections.singletonList("u1");
    ...
    public void testGetUserDetailFromResponse_WithErrors_ThrowsSyncServiceException() throws Exception {
    ...
    @Test(expected = ParseResponseException.class)
    public void testGetUserDetailFromResponse_NullResponse_ThrowsParseResponseException() throws Exception {
        ResponseWrapper<UserDetailResponseDto> wrapper = new ResponseWrapper<>();
    ...
    @Test
    public void testFetchUsersPaged_ReturnsAllPages() {
        String regCenterId = "RC1";
        UserDetails u1 = mock(UserDetails.class);
        when(u1.getIsActive()).thenReturn(true);
        when(u1.getIsDeleted()).thenReturn(false);
    ...
    @Test
    public void testGetAllUserDetailsBasedOnKeyIndexV2_SuccessEncrypts() throws Exception {
    ...
    @Test
    public void testGetAllUserDetailsBasedOnKeyIndexV2_NoUsers_NoEncryption() {
        String keyIndex = "KEY1";
        String regCenterId = "RC1";
        RegistrationCenterMachineDto machineDto = new RegistrationCenterMachineDto();
        machineDto.setRegCenterId(regCenterId);
