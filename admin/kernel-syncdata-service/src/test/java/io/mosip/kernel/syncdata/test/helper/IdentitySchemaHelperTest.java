...
public class IdentitySchemaHelperTest {
    ...
    @Test
    public void testGetLatestIdentitySchema_Normal_NoErrors() throws Exception {
        // given
    ...
    public void testGetLatestIdentitySchema_WithErrors_ThrowsSyncDataServiceException() throws Exception {
        // given
        ObjectNode node = new ObjectMapper().createObjectNode();
        ResponseWrapper<ObjectNode> wrapper = new ResponseWrapper<>();
        wrapper.setResponse(node);
    ...
    @Test
    public void testGetLatestIdentitySchema_RegistrationClientSchema_RetainsSpecificFields() throws Exception {
        // given
        ObjectNode node = new ObjectMapper().createObjectNode();
        ...
        // then : seuls les champs de responseProperties115 doivent rester
    ...
    @Test(expected = SyncDataServiceException.class)
    public void testGetLatestIdentitySchema_OnException_ThrowsSyncDataServiceException() throws Exception {
        // given
