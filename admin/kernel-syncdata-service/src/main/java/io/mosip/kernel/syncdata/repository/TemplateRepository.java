...
public interface TemplateRepository extends JpaRepository<Template, String> {
	...
	@Query(value = "select new io.mosip.kernel.syncdata.dto.EntityDtimes(max(aam.createdDateTime), max(aam.updatedDateTime), max(aam.deletedDateTime)) from Template aam ")
