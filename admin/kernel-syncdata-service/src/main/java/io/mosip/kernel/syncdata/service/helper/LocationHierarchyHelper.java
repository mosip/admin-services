...
public class LocationHierarchyHelper {
	...
	CompletableFuture<List<LocationHierarchyLevelDto>> locationHierarchyLevelDtos = null;
	...
	public void fillRetrievedData(final SyncMasterDataServiceHelper serviceHelper, final List<SyncDataBaseDto> list) 
		...
		serviceHelper.getSyncDataBaseDto(LocationHierarchy.class, "structured", this.locationHierarchyLevelDtos.get(), this.publicKey, list);
	}
