...
public enum TemplateTypeErrorCode {
	...
	TEMPLATE_TYPE_FETCH_EXCEPTION("KER-MSD-247", "Error occurred while fetching Template Type"),
	TEMPLATE_TYPE_NOT_FOUND_EXCEPTION("KER-MSD-249", "Template Type not Found");
