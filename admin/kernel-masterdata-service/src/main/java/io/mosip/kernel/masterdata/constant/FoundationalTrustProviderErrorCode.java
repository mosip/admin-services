...
public enum FoundationalTrustProviderErrorCode {
	ID_NOT_PRESENT("ADM-DPM-054", "FTP is not present for id"),
	MANDATORY_PARAM_MISSING("ADM-DPM-053", "Mandatory input parameter is missing"),
	FTP_ALREADY_PRESENT("ADM-DPM-055", "Foundational Trust Provider already exist"),
