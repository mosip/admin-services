...
public enum RegistrationCenterErrorCode {
	...
	REGISTRATION_CENTER_NOT_FOUND("KER-MSD-215", "Registration Center not found"),
	...
	DEPENDENCY_EXCEPTION("KER-MSD-192", "Cannot delete as dependency found"),
	DATE_TIME_PARSE_EXCEPTION("KER-MSD-043", "Invalid date format"),
	REGISTRATION_CENTER_LUNCH_START_CENTER_END_EXCEPTION("KER-MSD-259",
			"Lunch Start time cannot less than Center Start time"),
	REGISTRATION_CENTER_LUNCH_END_CENTER_END_EXCEPTION("KER-MSD-260",
	...
	REGISTRATION_CENTER_FORMATE_EXCEPTION("KER-MSD-307",
			"Latitude or Longitude must have maximum 2 digits before and minimum 4 digits after decimal"),
	DATA_TO_BE_VALIDATED_WITH_NOT_FOUND("KER-MSD-703", "start/end time Data not configured in database"),
	...
	LATITUDE_NOT_UNIQUE("KER-MSD-264", "Please make sure that all entered Latitude are same-%s"),
	LONGITUDE_NOT_UNIQUE("KER-MSD-265", "Please make sure that all entered Longitude are same-%s"),
	...
	TIME_ZONE_NOT_UNIQUE("KER-MSD-253", "Please make sure that all entered Time-Zone are same-%s"),
	HOLIDAY_LOCATION_CODE_NOT_UNIQUE("KER-MSD-373",
			"Please make sure that all entered Holiday-Location-Code are same-%s"),
	ZONE_CODE_NOT_UNIQUE("KER-MSD-218", "Please make sure that all entered Zone-Code are same-%s"),
	...
	DECOMMISSIONED("KER-MSD-216",
			"Registration center has been already decommissioned or Registration center not found"),
	HOLIDAY_NOT_FOUND("KER-MSD-221", "HolidayLocationCode Not Found"),
