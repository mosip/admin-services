...
public enum DeviceProviderManagementErrorCode {
	...
	PROVIDER_AND_TYPE_MAPPED("ADM-DPM-051", "Device code does not match against - type"),
	PROVIDER_AND_SUBTYPE_MAPPED("ADM-DPM-052", "Device code does not match against - subType"),
