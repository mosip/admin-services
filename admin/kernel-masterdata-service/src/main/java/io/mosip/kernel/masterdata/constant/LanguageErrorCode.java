...
public enum LanguageErrorCode {
	...
	LANGUAGE_UPDATE_EXCEPTION("KER-MSD-701", "Error occured while updating Language"),
	LANGUAGE_DELETE_EXCEPTION("KER-MSD-702", "Error occured while deleting Language");
