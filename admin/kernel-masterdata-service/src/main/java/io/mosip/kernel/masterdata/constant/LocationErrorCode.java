...
public enum LocationErrorCode {
	...
	LOCATION_LEVEL_FETCH_EXCEPTION("KER-MSD-241", "Error occured while fetching Location Hierarchy Levels"),
	LOCATION_INSERT_EXCEPTION("KER-MSD-242", "Error occured while inserting location hierarchy details"),
	...
	INVALID_HIERARCY_LEVEL("KER-MSD-244",
	...
	PARENT_LOC_NOT_FOUND("KER-MSD-243", "Parent location not found"),
