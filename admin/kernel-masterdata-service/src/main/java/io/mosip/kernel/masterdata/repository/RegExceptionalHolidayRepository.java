...
public interface RegExceptionalHolidayRepository
	...
	@Query("From RegExceptionalHoliday where registrationCenterId=?1 and (isDeleted is null or isDeleted = false) and isActive = true")
	public List<RegExceptionalHoliday> findByRegId(String registrationCenterId);
